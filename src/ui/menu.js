...
async function addServiceForm(projectName) {
    ...
    const answers = await inquirer.prompt([
        ...
        },
        {
            type: 'list',
            name: 'technology',
            message: 'Technologie à utiliser:',
            choices: [
        ...
        },
        {
            ...
            default: (answers) => {
                switch(answers.technology) {
                    ...
                    case 'php': return 'php -S 0.0.0.0:8000';
            ...
            choices: [
                ...servicesList.map(s => {
                    ...
                    const techIcon = {
                        ...
                        'python': '🐍',
                        'php': '🐘'
                    }[s.technology || 'nodejs'] || '⚙️';
                    return {
                        name: `${techIcon} ${s.name} (${s.command})${chalk.gray(setupInfo)}`,
                        value: s.name
                    };
                }),
                new inquirer.Separator(),
    ...
    const answers = await inquirer.prompt([
        {
            ...
            default: service.technology || 'nodejs'
        },
        {
            type: 'input',
            name: 'directory',
